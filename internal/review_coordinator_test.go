...
// is the regression test for a coder-linked reviewer whose
...
// advance it. Confirmed this is already fixed on main rather than actually
// broken; this test
...
// is the regression test for publishAndSnapshotConvergentReview
...
// requirement ID -- a real identity change, still correctly rejected; see
// TestTransitionReviewLedgerRejectsPlannedCoverageDescriptionRewrite)
// rather than a carried-coverage false positive, since the fix under test here
