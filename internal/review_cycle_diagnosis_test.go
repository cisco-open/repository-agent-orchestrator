...
// CanonicalFindings, the same class of corruption as an orphaned
...
// against a real staleness bug: a verification/challenge assignment can be
...
// the regression test for independent review feedback: several
