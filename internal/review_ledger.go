...
// cause as issue #134's carried-coverage conflict false positive, just
...
//
// See issue #134: comparing the whole ReviewCoverageRequirement via
// reflect.DeepEqual treated that expected, legitimate per-round variation
