...
// regression test: a comment carrying the *exact* same
...
// same ID. Making a same-ID collision from a different reviewer
// non-fatal (skip and publish anyway) leaves both comments claiming the
...
// regression test for the rollout hazard:
