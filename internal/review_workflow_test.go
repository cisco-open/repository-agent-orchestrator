...
// TestLaunchReviewAgentDoesNotBlockOnHardGate is the regression test:
// LaunchReviewAgent used to run the entire mandatory-test hard
...
// regression test: splitting a review launch into synchronous (registerReviewAgent,
...
// TestPollActiveAgentResumesReviewGateReviewerAfterRestart is the regression
// test for a real production incident, reproduced by round-tripping a
// realistic persisted reviewer through the actual
...
// is the regression test: ActiveReviewAgentID,
...
func TestMaybePromoteReadyForHumanReviewSkipsCoderWithNonTerminalLinkedReviewer(t *testing.T) {
	...
	coder := &Agent{
		...
		PRNumber:                991,
		PRURL:                   "https://github.com/acme/widget/pull/991",
		ObservedPRHeadSHA:       testReviewHeadSHA,
...
func TestIsManualReviewHoldForHead(t *testing.T) {
	...
	// case for review feedback: ContinueAgentForIssuePR
...
// regression test: reviewLaunchStillOwned can
