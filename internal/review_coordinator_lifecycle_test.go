...
// for a real production incident on issue #982/PR #1054: a reviewer
...
// is the regression test for review feedback on PR #183 (Craig): the
...
// paired with a still-running linked attempt, as Craig described) rather
