...
// the regression test for a real production incident on issue #982/PR
// #992: a reviewer that had already been fully retired via StateStopped
...
// is the regression test for review feedback on PR #157 (issue #156):
