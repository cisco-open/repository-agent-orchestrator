...
func TestFormatEffectiveConfigReportShowsDefaultedFields(t *testing.T) {
	...
	cfg := Config{
		...
		RepoPath:             "/home/jmlake/zeekfoundry",
		LogDir:               "/home/jmlake/zeekfoundry/.repository-agent-orchestrator",
		WorktreeDir:          "/home/jmlake/zeekfoundry/.worktrees",
		BaseBranch:           "main",
		MergeMethod:          "squash",
	...
	if !strings.Contains(report, "infrasec-cto/zeekfoundry") {
